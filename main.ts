...
let mySprite2 = sprites.create(img`
    ...
    2 f 2 2 2 2 f f f f f f f 2 2 f 
    2 f 2 f f 2 f f f f f f 2 f f 2 
    2 f 2 f 2 2 f f 2 f 2 f f f 2 f 
    2 f 2 2 2 f f f f 2 f f f 2 f f 
    2 f 2 f 2 2 f f 2 f 2 f 2 f 2 f 
    2 f 2 f f 2 f f f f f 2 f f f 2 
    2 f 2 f f 2 f f f f f f f f f f 
    2 f 2 2 2 2 f f f f f f f f f f 
    2 f f f f f f f f f f f f f f f 
    2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 
    `, SpriteKind.Player)
let vx_wbx = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    ...
    2 f f f f f f f f f f f f f f f 
    2 f f f f f f f f f f f f f f f 
    2 f f 2 f f f f f 2 f f f 2 f f 
    2 f 2 2 2 f f f 2 f 2 f f 2 f f 
    2 2 f 2 f 2 f 2 f f f 2 f 2 f f 
    2 f f 2 f f f 2 2 2 2 2 f 2 f f 
    2 f f 2 f f f 2 f f f 2 f 2 f f 
    2 f f 2 f f f 2 f f f 2 f 2 2 2 
    2 f f f f f f f f f f f f f f f 
    2 f f f f f f f f f f f f f f f 
    2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 
    `, SpriteKind.Player)
mySprite2.setPosition(142, 39)
vx_wbx.setPosition(140, 64)
...
vx_wbx.changeScale(1, ScaleAnchor.Middle)
forever(function () {
    if (info.score() > 99 && controller.B.isPressed()) {
        score += score * 2
        info.changeScoreBy(-100)
    } else if (info.score() > 199 && controller.up.isPressed()) {
        auto += 1
